    ...
    public function data(): array
    {
        return [
            ...
            [
                'code_language' => 'en',
                'index' => 'sub_slider',
                'text' => 'FINAL SOLUTION solve the problem',
                'created_at' => $this->time,
                'updated_at' => $this->time,
            ],
            [
            ...
            [
                ...
                'text' => 'Copyright pintukeluar is brand by PT Cadadusa Acintya Dakara',
                'created_at' => $this->time,
                'updated_at' => $this->time,
            ],
            [
            ...
            [
                'code_language' => 'en',
                'index' => 'sub_satu',
                'text' => 'Find the exit, order from home, order from work <br> ORDER FROM ANYWHERE',
                'created_at' => $this->time,
                'updated_at' => $this->time,
            ],
            [
            ...
            [
                'code_language' => 'en',
                'index' => 'service_cloud',
                'text' => 'Avoid heat, rain, wind. With this solution, sitting quietly at home, office, shop/cafe, everything can be resolved.',
                'created_at' => $this->time,
                'updated_at' => $this->time,
            ],
            [
