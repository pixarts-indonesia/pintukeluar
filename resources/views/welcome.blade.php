<html class="js sizes customelements history pointerevents postmessage postmessage-structuredclones webgl websockets cssanimations csscolumns csscolumns-width csscolumns-span csscolumns-fill csscolumns-gap csscolumns-rule csscolumns-rulecolor csscolumns-rulestyle csscolumns-rulewidth csscolumns-breakbefore csscolumns-breakafter csscolumns-breakinside flexbox picture srcset webworkers" lang="en"><head>
    ...
    <link rel="stylesheet" href="https://htmldemo.net/carserv/carserv/assets/css/vendor/plugins.min.css">
    <link rel="stylesheet" href="https://htmldemo.net/carserv/carserv/assets/css/style.min.css">
...
<body data-aos-easing="ease" data-aos-duration="1500" data-aos-delay="0">
    ...
    <div class="main-wrapper">
        ...
        <div class="section slider-section">
            ...
            <!-- Slider Section Start -->
            <div class="single-slider" style="background-image: url(assets/images/slider/slider-bg.jpg);">
                <div class="container">

                    <!-- Slider Section Start -->
                    <div class="slider-content">
                        <h5 class="sub-title aos-init aos-animate" data-aos="fade-up" data-aos-delay="100"> a garage for all models </h5>
                        <h1 class="main-title aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">Need to Service or repair your car?</h1>
                        <p data-aos="fade-up" data-aos-delay="600" class="aos-init aos-animate">Car servicing rationally encounter consequences that extremely painful. Nor again is there anyone who loves or pursues </p>
                        <a href="contact.html" data-aos="fade-up" data-aos-delay="800" class="btn btn-custom-01 aos-init">Contact us</a>
                    </div>
                    <!-- Slider Section End -->
                ...
                <div class="slider-images-02">
                    <div class="image aos-init" data-aos="fade-right" data-aos-delay="1300">
                    ...
                    <div class="row align-items-end">
                        <div class="col-lg-6">
                            ...
                            <div class="about-images">
                                <div class="images aos-init" data-aos="fade-right" data-aos-delay="200">
                                    <img src="assets/images/about/about.png" alt="About">
                                </div>
                                <div class="exprience aos-init" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="col-lg-6">
                            <!-- About Content Start -->
                            <div class="about-content aos-init" data-aos="fade-left" data-aos-delay="200">

                                <!-- Section Title Start -->
                                <div class="section-title">
                                    <h5 class="sub-title">Welcome to <strong>Carserv</strong>.</h5>
                                    <h2 class="main-title">Latest Equipments with Trusted Service</h2>
                                </div>
                                <!-- Section Title End -->
                    ...
                    <div class="service-wrapper">
                        <div class="row gx-lg-5">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service aos-init" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="service-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;" xml:space="preserve">
                                            <g>
                                                ...
                                                C375.67,80.18,379.93,83.25,380.66,87.76L380.66,87.76z M380.66,87.76"></path>
                                                <path class="icon-path" d="M380.8,121.33c0,4.57-3.7,8.29-8.29,8.29c-4.57,0-8.29-3.71-8.29-8.29c0-4.58,3.71-8.29,8.29-8.29
                                                C377.1,113.04,380.8,116.75,380.8,121.33L380.8,121.33z M380.8,121.33"></path>
                                                <path class="icon-path" d="M380.8,153.63c0,4.58-3.71,8.29-8.29,8.29c-4.57,0-8.29-3.7-8.29-8.29c0-4.57,3.71-8.29,8.29-8.29
                                                C377.09,145.34,380.8,149.05,380.8,153.63L380.8,153.63z M380.8,153.63"></path>
                                                <path class="icon-path" d="M295.36,148.35c3.96-2.29,5.32-7.36,3.03-11.32l-32.3-55.94c-2.28-3.96-7.35-5.32-11.32-3.03
                                                c-3.97,2.29-5.32,7.36-3.03,11.32l32.3,55.94C286.33,149.29,291.4,150.63,295.36,148.35L295.36,148.35z M295.36,148.35"></path>
                                                <path class="icon-path" d="M529.69,245.27c-2.28-3.96-7.35-5.32-11.32-3.03l-55.94,32.29c-3.96,2.29-5.32,7.36-3.03,11.32
                                                c2.29,3.97,7.36,5.32,11.32,3.04l55.94-32.3C530.62,254.3,531.98,249.23,529.69,245.27L529.69,245.27z M529.69,245.27"></path>
                                                <path class="icon-path" d="M321.89,449.89c-3.96,2.29-5.32,7.36-3.03,11.32l32.29,55.94c2.29,3.97,7.36,5.32,11.32,3.03
                                                c3.96-2.29,5.32-7.36,3.03-11.32l-32.3-55.94C330.93,448.96,325.86,447.61,321.89,449.89L321.89,449.89z M321.89,449.89"></path>
                                                ...
                                                c0,4.07-3.3,7.37-7.37,7.37C304.56,226.68,301.25,223.38,301.25,219.31L301.25,219.31z M301.25,219.31"></path>
                                                ...
                                                L232.14,259.21z M232.14,259.21"></path>
                                                ...
                                                L239.84,331.85z M239.84,331.85"></path>
                                                ...
                                                L377.74,251.84z M377.74,251.84"></path>
                                                ...
                                                L377.41,331.85z M377.41,331.85"></path>
                                                ...
                                                l20.06,20.06L454.37,550.7z M454.37,550.7"></path>
                                                ...
                                                c-4.98,0-9.04-4.06-9.04-9.04c0-4.99,4.06-9.05,9.04-9.05C85.34,283.31,89.39,287.37,89.39,292.36L89.39,292.36z M89.39,292.36"></path>
                                                ...
                                                c0,3.05-2.48,5.53-5.52,5.53C108.44,171.98,105.96,169.5,105.96,166.45L105.96,166.45z M105.96,166.45"></path>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service aos-init" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div class="service-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;" xml:space="preserve">
                                            ...
                                            c9.88-7.29,23.36-6.28,32.04,2.41l100.29,100.29C573.02,192.23,574.04,205.71,566.75,215.59L566.75,215.59z M566.75,215.59"></path>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service aos-init" data-aos="fade-up" data-aos-delay="600">
                                    ...
                                    <div class="service-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;" xml:space="preserve">
                                            <g>
                                                ...
                                                C392.59,434.05,398.46,428.18,405.67,428.18L405.67,428.18z M405.67,428.18"></path>
                                                <path class="icon-path" d="M265.51,434.9h74.43c4.29,0,7.76-3.47,7.76-7.76c0-4.29-3.47-7.75-7.76-7.75h-74.43
                                                c-4.28,0-7.75,3.47-7.75,7.75C257.76,431.43,261.23,434.9,265.51,434.9L265.51,434.9z M265.51,434.9"></path>
                                                <path class="icon-path" d="M265.51,463.14h74.43c4.29,0,7.76-3.47,7.76-7.76c0-4.29-3.47-7.76-7.76-7.76h-74.43
                                                c-4.28,0-7.75,3.48-7.75,7.76C257.76,459.67,261.23,463.14,265.51,463.14L265.51,463.14z M265.51,463.14"></path>
                                                <path class="icon-path" d="M224.97,194.3v-11.87c0-4.29-3.48-7.76-7.76-7.76c-4.29,0-7.76,3.47-7.76,7.76v11.87
                                                c0,4.29,3.48,7.76,7.76,7.76C221.49,202.06,224.97,198.59,224.97,194.3L224.97,194.3z M224.97,194.3"></path>
                                                <path class="icon-path" d="M283.89,194.3v-11.87c0-4.29-3.47-7.76-7.75-7.76c-4.29,0-7.76,3.47-7.76,7.76v11.87
                                                c0,4.29,3.47,7.76,7.76,7.76C280.42,202.06,283.89,198.59,283.89,194.3L283.89,194.3z M283.89,194.3"></path>
                                                <path class="icon-path" d="M342.82,194.3v-11.87c0-4.29-3.47-7.76-7.76-7.76c-4.28,0-7.75,3.47-7.75,7.76v11.87
                                                c0,4.29,3.47,7.76,7.75,7.76C339.35,202.06,342.82,198.59,342.82,194.3L342.82,194.3z M342.82,194.3"></path>
                                                <path class="icon-path" d="M401.75,194.3v-11.87c0-4.29-3.47-7.76-7.76-7.76c-4.28,0-7.76,3.47-7.76,7.76v11.87
                                                c0,4.29,3.48,7.76,7.76,7.76C398.28,202.06,401.75,198.59,401.75,194.3L401.75,194.3z M401.75,194.3"></path>
                                                ...
                                                v11.88C238.91,225.15,242.38,228.62,246.67,228.62L246.67,228.62z M246.67,228.62"></path>
                                                <path class="icon-path" d="M313.36,220.86v-11.88c0-4.28-3.48-7.76-7.76-7.76c-4.28,0-7.76,3.48-7.76,7.76v11.88
                                                c0,4.29,3.48,7.76,7.76,7.76C309.88,228.62,313.36,225.15,313.36,220.86L313.36,220.86z M313.36,220.86"></path>
                                                <path class="icon-path" d="M372.29,220.86v-11.88c0-4.28-3.48-7.76-7.76-7.76c-4.29,0-7.76,3.48-7.76,7.76v11.88
                                                c0,4.29,3.47,7.76,7.76,7.76C368.81,228.62,372.29,225.15,372.29,220.86L372.29,220.86z M372.29,220.86"></path>
                                                ...
                                                c-13.52,0-24.53-11.01-24.53-24.53v-23.95h49.05V529.32z M435.32,529.32"></path>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service aos-init" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <div class="service-icon">
                                        ...
                                        c14.95,0,27.11,12.16,27.11,27.11v216.9C422.51,463,410.34,475.17,395.39,475.17L395.39,475.17z M395.39,475.17"></path>
                                        ...
                                        l22.18-81.34h26.29l-18.07,63.26h34.02l-30.55,66.17l10.75-48.1H271.67z M271.67,339.6"></path>
                                        ...
                                        H61.01V149.82h488.02V529.39z M549.03,529.39"></path>
                                            ...
                                            <path d="M115.24,384.79h18.07v-36.15h36.15v-18.07h-36.15v-36.15h-18.07v36.15H79.09v18.07h36.15V384.79z M115.24,384.79"></path>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service aos-init" data-aos="fade-up" data-aos-delay="400">
                                    ...
                                    <div class="service-icon">
                                        ...
                                        C330.52,223.77,342.43,235.69,342.43,250.34L342.43,250.34z M342.43,250.34"></path>
                                        ...
                                        s39.71-88.53,88.53-88.53s88.53,39.71,88.53,88.53S267.31,445.11,218.49,445.11L218.49,445.11z M218.49,445.11"></path>
                                        ...
                                        C130.88,232.63,138.81,240.55,138.81,250.34L138.81,250.34z M138.81,250.34"></path>
                                        ...
                                        C325.65,232.63,333.58,240.55,333.58,250.34L333.58,250.34z M333.58,250.34"></path>
                                        ...
                                        C130.88,445.11,138.81,453.04,138.81,462.82L138.81,462.82z M138.81,462.82"></path>
                                        ...
                                        C325.65,445.11,333.58,453.04,333.58,462.82L333.58,462.82z M333.58,462.82"></path>
                                        ...
                                        c2.28,3.04,3.54,6.81,3.54,10.62C563.77,215.83,555.83,223.77,546.06,223.77L546.06,223.77z M546.06,223.77"></path>
                                        ...
                                        M546.06,117.53h-17.71V90.97h17.71V117.53z M546.06,117.53"></path>
                                            <rect x="67.98" y="170.65" class="icon-path" width="123.95" height="17.71"></rect>
                                        </svg>
                                    </div>
                                </div>
                                <!-- Single Service End -->
        ...
        <div class="section section-padding-02">
            <div class="container">
                ...
                <div class="call-to-action-wrapper">
                    ...
                    <div class="call-to-action-images" style="background-image: url(assets/images/call-to-action-bg.jpg);"></div>
                ...
                <div class="choose-wrapper">
                    <div class="row align-items-center gx-xl-0">
                        <div class="col-lg-5">
                            ...
                            <div class="choose-content aos-init" data-aos="fade-right" data-aos-delay="300">
                                <!-- Section Title Start -->
                                <div class="section-title">
                                ...
                                <img src="assets/images/choose/choose.png" alt="Choose">
                            </div>
                            ...
                            <div class="choose-items-wrapper">
                                <div class="row gx-xl-5 align-items-center">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="single-choose-item aos-init" data-aos="fade-up" data-aos-delay="200">
                                            <div class="item-icon">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <!-- Single Choose Item Start -->
                                        <div class="single-choose-item aos-init" data-aos="fade-up" data-aos-delay="400">
                                            <div class="item-icon">
                ...
                <div class="how-we-work-wrapper">
                    <div class="row">
                        <div class="col-lg-3 col-sm-6">
                            <!-- Single Work Start -->
                            <div class="single-work aos-init" data-aos="fade-up" data-aos-delay="100">
                                <span class="number">01</span>
                                <div class="content-wrapper">
                                    <img src="assets/images/work/work-1.png" alt="Work">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <!-- Single Work Start -->
                            <div class="single-work aos-init" data-aos="fade-up" data-aos-delay="200">
                                <span class="number">02</span>
                                <div class="content-wrapper">
                                    <img src="assets/images/work/work-2.png" alt="Work">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <!-- Single Work Start -->
                            <div class="single-work aos-init" data-aos="fade-up" data-aos-delay="300">
                                <span class="number">03</span>
                                <div class="content-wrapper">
                                    <img src="assets/images/work/work-3.png" alt="Work">
                        ...
                        <div class="col-lg-3 col-sm-6">
                            <!-- Single Work Start -->
                            <div class="single-work aos-init" data-aos="fade-up" data-aos-delay="400">
                                <span class="number">04</span>
                                <div class="content-wrapper">
                                    <img src="assets/images/work/work-4.png" alt="Work">
            ...
            <div class="container">
                ...
                <div class="testimonials-wrapper">
                    ...
                    <div class="testimonials-items testimonial-active">
                        ...
                        <img class="shape" src="assets/images/testimonials.png" alt="Testimonials">

                        <img class="quote" src="assets/images/quote.svg" alt="quote">

                        <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                            <div class="swiper-wrapper" id="swiper-wrapper-e5fe0c9f2462eb47" aria-live="polite" style="transform: translate3d(0px, 0px, 0px);">
                                <div class="swiper-slide swiper-slide-active" role="group" aria-label="1 / 3" style="width: 504px;">
                                ...
                                <div class="swiper-slide swiper-slide-next" role="group" aria-label="2 / 3" style="width: 504px;">
                                    <!-- Single Testimonials Start -->
                                    <div class="single-testimonials">
                                        <img class="author" src="assets/images/author/author-02.jpg" alt="Author">
                                        <h3 class="name">Crystopher Lopez</h3>
                                        <p>Great service makes me happy, my car is like the most the new one is our main goal extremely painful again is there anyone who loves our to take</p>
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
                                ...
                                <div class="swiper-slide" role="group" aria-label="3 / 3" style="width: 504px;">
                                    <!-- Single Testimonials Start -->
                                    <div class="single-testimonials">
                                        <img class="author" src="assets/images/author/author-03.jpg" alt="Author">
                                        <h3 class="name">Crystopher Lopez</h3>
                                        <p>Great service makes me happy, my car is like the most the new one is our main goal extremely painful again is there anyone who loves our to take</p>
                                        <div class="rating">
                                            <i class="fa fa-star"></i>
        ...
        <div class="section section-padding">
            <div class="container">
                ...
                <div class="brand-wrapper brand-active">
                    <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                        <div class="swiper-wrapper" id="swiper-wrapper-f3461ef1655ae9af" aria-live="off" style="transform: translate3d(-1286px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" role="group" aria-label="5 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="0">
                            ...
                            </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-next" role="group" aria-label="6 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="1">
                            ...
                            </div><div class="swiper-slide swiper-slide-duplicate" role="group" aria-label="7 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="2">
                            ...
                            </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" role="group" aria-label="8 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="3">
                            ...
                            <div class="swiper-slide swiper-slide-active" role="group" aria-label="5 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="0">
                            ...
                            <div class="swiper-slide swiper-slide-next" role="group" aria-label="6 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="1">
                            ...
                            <div class="swiper-slide" role="group" aria-label="7 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="2">
                            ...
                            <div class="swiper-slide swiper-slide-duplicate-prev" role="group" aria-label="8 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="3">
                        ...
                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" role="group" aria-label="5 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="0">
                            ...
                            </div><div class="swiper-slide swiper-slide-duplicate" role="group" aria-label="8 / 12" style="width: 211.5px; margin-right: 110px;" data-swiper-slide-index="3">
                    ...
                    <div class="footer-widget-wrapper">
                        <div class="row">
                            <div class="col-lg-3 col-md-6 order-md-1 order-lg-1">
                                ...
                                <!-- Footer Widget Start -->
                                <div class="footer-widget aos-init" data-aos="fade-up" data-aos-delay="100">
                            ...
                            <div class="col-lg-6 order-md-3 order-lg-2">
                                ...
                                <div class="footer-link-wrapper">
                                    ...
                                    <!-- Footer Widget Start -->
                                    <div class="footer-widget aos-init" data-aos="fade-up" data-aos-delay="200">
                                    ...
                                    <!-- Footer Widget Start -->
                                    <div class="footer-widget aos-init" data-aos="fade-up" data-aos-delay="300">
                            ...
                            <div class="col-lg-3 col-md-6 order-md-2 order-lg-3">
                                ...
                                <!-- Footer Widget Start -->
                                <div class="footer-widget aos-init" data-aos="fade-up" data-aos-delay="400">
                                    <h3 class="footer-widget-title">Information</h3>
    ...
    <script src="https://htmldemo.net/carserv/carserv/assets/js/vendor/modernizr-3.11.2.min.js"></script>
    <script src="https://htmldemo.net/carserv/carserv/assets/js/vendor/jquery-3.6.0.min.js"></script>
    ...
    <!--====== Use the minified version files listed below for better performance and remove the files listed above ======-->
    <script src="https://htmldemo.net/carserv/carserv/assets/js/plugins.min.js"></script>


    <!-- Main JS -->
    <script src="https://htmldemo.net/carserv/carserv/assets/js/main.js"></script>
