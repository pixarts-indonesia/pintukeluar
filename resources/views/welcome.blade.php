            ...
            <div class="relative pt-36 ml-auto">
                <div class="lg:w-2/3 text-center mx-auto">
                    <h1 class="text-gray-900 dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
                        <span class="text-primary dark:text-white">SOLUSI AKHIR </span> menyelesaikan masalah        
                    </h1>
    ...
    <div id="features">
        <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
            <div class="md:w-2/3 lg:w-1/2">
                ...
                <p class="text-gray-600 dark:text-gray-300">Menyelesaikan masalah anda hanya di pintukeluar mudah, efisien dan aman.</p>
            </div>
