    ...
    <div class="single-slider" style="background-image: url(assets/images/slider-bg.png);">
        <div class="container">
            ...
            <div class="slider-content">
                <h5 class="sub-title aos-init aos-animate" data-aos="fade-up" data-aos-delay="100"> solusi akhir menyelesaikan masalah </h5>
                <h1 class="main-title aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">Kendaraan anda butuh diservis?</h1>
                ...
                <a href="contact.html" data-aos="fade-up" data-aos-delay="800" class="btn btn-custom-01 aos-init aos-animate">Gabung</a>
            </div>
            <!-- Slider Section End -->
            ...
            <div class="row align-items-end">
                <div class="col-lg-6">
                    ...
                    <div class="about-images">
                        ...
                        <!-- <div class="exprience aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content aos-init aos-animate" data-aos="fade-left" data-aos-delay="200">
                        ...
                        <p>Jika kendaraan anda mengalami masalah, segera hubungi pintukeluar, kendaraan anda akan kembali normal dan aktifitas lancar</p>
        ...
        <div class="call-to-action-wrapper">
            ...
            <div class="call-to-action-content">
                <div class="content-wrapper">
                    ...
                    <!-- Section Title End -->
                    <p>Silahkan hubungi kami jika kendaraan anda mengalami masalah, kami akan menyelesaikan masalah kendaraan anda</p>
            ...
            <div class="call-to-action-images" style="background-image: url(assets/images/call-to-action-bg.png);"></div>
                    ...
                    <div class="choose-items-wrapper">
                        <div class="row gx-xl-5 align-items-center">
                            <div class="col-sm-6">
                                ...
                                <div class="single-choose-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                                    <div class="item-icon">
                            ...
                            <div class="col-sm-6">
                                ...
                                <!-- Single Choose Item Start -->
                                <div class="single-choose-item aos-init aos-animate" data-aos="fade-up" data-aos-delay="400">
                                    <div class="item-icon">
        ...
        <div class="testimonials-wrapper">
            ...
            <div class="testimonials-items testimonial-active">
                ...
                <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                    <div class="swiper-wrapper" id="swiper-wrapper-44bdf6510cc8bdd87" aria-live="polite" style="transform: translate3d(-1008px, 0px, 0px); transition-duration: 0ms;">
                        ...
                        <div class="swiper-slide swiper-slide-prev" role="group" aria-label="2 / 3" style="width: 504px;">
                            <!-- Single Testimonials Start -->
                            <div class="single-testimonials">
                                <img class="author" src="{{ asset('assets/images/user.png') }}" alt="Pintukeluar">
                                <h3 class="name">Crystopher Lopez</h3>
                        ...
                        <div class="swiper-slide swiper-slide-active" role="group" aria-label="3 / 3" style="width: 504px;">
                            <!-- Single Testimonials Start -->
                            <div class="single-testimonials">
                                <img class="author" src="{{ asset('assets/images/user.png') }}" alt="Pintukeluar">
                                <h3 class="name">Crystopher Lopez</h3>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-blog aos-init" data-aos="fade-up" data-aos-delay="200">
                            <div class="blog-image">
                                <a href="blog-details-right-sidebar.html"><img src="{{ asset('assets/images/blog-01.png') }}" alt="Pintukeluar"></a>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-blog aos-init" data-aos="fade-up" data-aos-delay="400">
                            <div class="blog-image">
                                <a href="blog-details-right-sidebar.html"><img src="{{ asset('assets/images/blog-02.png') }}" alt="Pintukeluar"></a>
                            </div>
                            <div class="blog-content">
                                <ul class="meta">
                                    <li> <i class="fa fa-calendar"></i> 28 May, 2023</li>
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="single-blog aos-init" data-aos="fade-up" data-aos-delay="600">
                            <div class="blog-image">
                                <a href="blog-details-right-sidebar.html"><img src="{{ asset('assets/images/blog-03.png') }}" alt="Pintukeluar"></a>
                            </div>
                            <div class="blog-content">
                                <ul class="meta">
                                    <li> <i class="fa fa-calendar"></i> 28 May, 2023</li>
...
<div class="section section-padding">
    <div class="container">
        ...
        <div class="brand-wrapper brand-active">
            <div class="swiper-container swiper-container-initialized swiper-container-horizontal swiper-container-pointer-events">
                <div class="swiper-wrapper" id="swiper-wrapper-14fc6df2100e3b6e10" aria-live="off" style="transform: translate3d(-2572px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="0" role="group" aria-label="1 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="1" role="group" aria-label="2 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="3 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="3" role="group" aria-label="4 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="5 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    <div class="swiper-slide swiper-slide-duplicate-next" data-swiper-slide-index="1" role="group" aria-label="6 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="7 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    <div class="swiper-slide swiper-slide-prev" data-swiper-slide-index="3" role="group" aria-label="8 / 12" style="width: 211.5px; margin-right: 110px;">
                ...
                <div class="swiper-slide swiper-slide-duplicate swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="9 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="10 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate" data-swiper-slide-index="2" role="group" aria-label="11 / 12" style="width: 211.5px; margin-right: 110px;">
                    ...
                    </div><div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-prev" data-swiper-slide-index="3" role="group" aria-label="12 / 12" style="width: 211.5px; margin-right: 110px;">
